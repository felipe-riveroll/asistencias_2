...
class TestNormalizacion:
    ...
    def test_normalize_leave_type_basic(self):
        ...
        assert normalize_leave_type("Permiso Sin Goce De Sueldo") == "permiso sin goce de sueldo"
        assert normalize_leave_type("  PERMISO MÉDICO  ") == "permiso médico"
...
class TestAjusteHorasPermisos:
    ...
    def test_permiso_sin_goce_no_descuenta(self):
        ...
        resultado = ajustar_horas_esperadas_con_permisos(df, permisos_dict, cache_horarios)
