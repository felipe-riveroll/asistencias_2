...
def test_obtener_horarios_multi_quincena():
    ...
    with patch('db_postgres_connection.obtener_tabla_horarios') as mock_obtener_tabla:
        ...
        mock_obtener_tabla.side_effect = lambda sucursal, es_primera, conn, codigos: [
            {"codigo_frappe": "EMP1", "nombre_sucursal": sucursal, "nombre_completo": "Empleado 1"} 
        ] if es_primera else [
            {"codigo_frappe": "EMP2", "nombre_sucursal": sucursal, "nombre_completo": "Empleado 2"}
        ]
        
        # Caso 1: Sólo primera quincena
        horarios = obtener_horarios_multi_quincena("Sucursal1", "conn-mock", ["EMP1", "EMP2"], 
                                                  incluye_primera=True, incluye_segunda=False)
        assert True in horarios
        assert False not in horarios
        mock_obtener_tabla.assert_called_once_with("Sucursal1", True, "conn-mock", ["EMP1", "EMP2"])
        mock_obtener_tabla.reset_mock()
        
        # Caso 2: Sólo segunda quincena
        horarios = obtener_horarios_multi_quincena("Sucursal1", "conn-mock", ["EMP1", "EMP2"], 
                                                  incluye_primera=False, incluye_segunda=True)
        assert False in horarios
        assert True not in horarios
        mock_obtener_tabla.assert_called_once_with("Sucursal1", False, "conn-mock", ["EMP1", "EMP2"])
        mock_obtener_tabla.reset_mock()
        
        # Caso 3: Ambas quincenas
        horarios = obtener_horarios_multi_quincena("Sucursal1", "conn-mock", ["EMP1", "EMP2"], 
                                                  incluye_primera=True, incluye_segunda=True)
        assert True in horarios
        assert False in horarios
        assert mock_obtener_tabla.call_count == 2
        mock_obtener_tabla.assert_any_call("Sucursal1", True, "conn-mock", ["EMP1", "EMP2"])
        mock_obtener_tabla.assert_any_call("Sucursal1", False, "conn-mock", ["EMP1", "EMP2"])
...
def test_mapear_horarios_empleado_multi():
    ...
    horarios_primera = [{
        ...
        "Lunes": {"horario_entrada": "09:00", "horario_salida": "18:00", "horas_totales": "9"},
        "Martes": {"horario_entrada": "09:00", "horario_salida": "18:00", "horas_totales": "9"},
        "Miércoles": None,
        "Jueves": {"horario_entrada": "09:00", "horario_salida": "18:00", "horas_totales": "9"},
        "Viernes": {"horario_entrada": "09:00", "horario_salida": "18:00", "horas_totales": "9"},
        "Sábado": None,
        "Domingo": None
    }]
    ...
    horarios_segunda = [{
        ...
        "nombre_completo": "Empleado 1",
        "nombre_sucursal": "Sucursal1",
        "Lunes": {"horario_entrada": "10:00", "horario_salida": "19:00", "horas_totales": "9"},
        "Martes": {"horario_entrada": "10:00", "horario_salida": "19:00", "horas_totales": "9"},
        "Miércoles": {"horario_entrada": "10:00", "horario_salida": "19:00", "horas_totales": "9"},
        "Jueves": None,
        "Viernes": {"horario_entrada": "10:00", "horario_salida": "19:00", "horas_totales": "9"},
        "Sábado": None,
        "Domingo": None
    }]
    
    # Probar con ambas quincenas
    horarios_por_quincena = {
        True: horarios_primera,
        False: horarios_segunda
    }
...
def test_deteccion_cruza_medianoche():
    ...
    horarios_primera = [{
        ...
        "nombre_completo": "Empleado 1",
        "nombre_sucursal": "Sucursal1",
        "Lunes": {"horario_entrada": "22:00", "horario_salida": "06:00", "horas_totales": "8"},
        "Martes": None,
        "Miércoles": None,
        "Jueves": None,
        "Viernes": None,
    ...
    cache = {
        "EMP1": {
            True: {  # Primera quincena
                1: {"hora_entrada": "09:00", "hora_salida": "18:00", "horas_totales": "9", "cruza_medianoche": False}
            },
            False: {  # Segunda quincena
                1: {"hora_entrada": "10:00", "hora_salida": "19:00", "horas_totales": "9", "cruza_medianoche": False}
            }
        }
    }
