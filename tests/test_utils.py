...
class TestDeterminePeriodType:
    ...
    def test_determine_period_type_first_half(self):
        ...
        incluye_primera, incluye_segunda = determine_period_type('2025-01-01', '2025-01-15')
    ...
    def test_determine_period_type_second_half(self):
        ...
        incluye_primera, incluye_segunda = determine_period_type('2025-01-16', '2025-01-31')
    ...
    def test_determine_period_type_full_month(self):
        ...
        incluye_primera, incluye_segunda = determine_period_type('2025-01-01', '2025-01-31')
        assert incluye_primera is True
        assert incluye_segunda is True
    
    def test_determine_period_type_cross_month_boundary(self):
        """Test period detection crossing month boundary."""
        incluye_primera, incluye_segunda = determine_period_type('2025-01-15', '2025-02-15')
    ...
    def test_determine_period_type_single_day_first_half(self):
        ...
        incluye_primera, incluye_segunda = determine_period_type('2025-01-10', '2025-01-10')
        assert incluye_primera is True
        assert incluye_segunda is False
    
    def test_determine_period_type_single_day_second_half(self):
        """Test period detection for single day in second half."""
        incluye_primera, incluye_segunda = determine_period_type('2025-01-20', '2025-01-20')
        assert incluye_primera is False
        assert incluye_segunda is True
    ...
    def test_determine_period_type_boundary_days(self):
        ...
        incluye_primera, incluye_segunda = determine_period_type('2025-01-15', '2025-01-15')
        assert incluye_primera is True
        assert incluye_segunda is False
        
        # 16th should be second half
        incluye_primera, incluye_segunda = determine_period_type('2025-01-16', '2025-01-16')
        assert incluye_primera is False
        assert incluye_segunda is True
    
    def test_determine_period_type_different_months(self):
        """Test period detection across different months."""
        incluye_primera, incluye_segunda = determine_period_type('2025-01-01', '2025-02-28')
...
class TestNormalizeLeaveType:
    ...
    def test_normalize_leave_type_known_types(self):
        ...
        test_cases = [
            ...
            ('COMPENSACIÓN DE TIEMPO POR TIEMPO', 'compensacion de tiempo por tiempo')  # Accents removed
        ]
...
class TestUtilsIntegration:
    ...
    def test_employee_extraction_and_period_detection(self):
        ...
        records = [
            ...
            {'employee': 'EMP002', 'employee_name': 'Jane Smith', 'time': '2025-01-15T09:00:00'}
        ]
    ...
    def test_safe_operations_robustness(self):
        ...
        for case in edge_cases:
            ...
            time_result = time_to_decimal(case) if isinstance(case, (str, type(None))) else 0
            td_result = safe_timedelta(case) if isinstance(case, (str, type(None))) else pd.Timedelta(0)
            normalize_result = normalize_leave_type(case) if isinstance(case, (str, type(None))) else ''
...
class TestUtilsPerformance:
    ...
    def test_large_employee_list_performance(self):
        ...
        for i in range(10000):
            large_records.extend([
                ...
                {'employee': f'EMP{i:05d}', 'employee_name': f'Employee {i}'}  # Duplicate
            ])
    ...
    def test_time_conversion_bulk_performance(self):
        ...
        time_strings = [f'{h:02d}:{m:02d}:{s:02d}' for h in range(24) for m in range(0, 60, 5) for s in range(0, 60, 15)]
